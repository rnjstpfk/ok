...
// 에셋들 (이미지 경로만 네 프로젝트에 맞게 바꿔줘)
/* import heroImg from "../assets/PEACH_EATABLES_HERO.avif"; */ // 좌측 큰 이미지

export default function Eatables() {
  return (
    <main className="eatables-page">
      {/* 상단 얇은 바 */}
      <div className="page-banner">NOT SURE WHERE YOU ARE BUT YOU ARE DEFINITELY HERE</div>
      ...
      <section className="container product">
        ...
        <div className="product-info">
          ...
          <div className="desc">
            ...
            <p className="bold">
              Each gummy contains 25 MG CBD and 100 MG L-Theanine.
            </p>
            ...
            <a className="faq" href="#">
              What are the benefits of CBD? I'm glad you asked.
            </a>
          </div>
        </div>
      </section>
